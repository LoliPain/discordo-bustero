...
# Discordo Bustero
![](https://img.shields.io/github/commit-activity/m/LoliPain/discordo-bustero/devbase?color=5865f2&logo=github)
...
### Development Base branch (Pre-release Candidate) 

Wanna be the coolest member of discord server? ***El Discordo Bustero*** will help you!

- [ ] **Very** *flexible configuration*
- [ ] **Very** **unaided to join servers*
- [ ] **Very** *strong against `MEE6` & other bots & terms of use*
- [ ] **Very** *good support custom dictionaries*
- [ ] **Very** *powerful for new method implementations* <del>*(**why?** because **very full typed** of course!)*</del>
- [ ] **Very** *free-to-use*
- [ ] **Very** *easy-to-start*
- [x] **Very** similar to master branch

*That's all about Discordo Bustero!*

## What's next?

Development Base is slightly tested PRC.
